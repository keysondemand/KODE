...
nf.node_share_index = json.load(open("../../secretsharing/combinatorial/tmp/css_node_share_index.txt"))
...
def node_thread(nid):
    ...
    timingfilename = "./tmp/css_dkgtiming_n_"+str(nf.N_NODES)+".csv"
...
if __name__ == "__main__":
    description = """ 
    This program provides a single node running the DKG instance using verifiable replicated secret sharing
    """
