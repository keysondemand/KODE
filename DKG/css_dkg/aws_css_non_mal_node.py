        ...
        if (MY_IP != NODE_IP[node_index]):
            ...
            if (node_index != nid):
                ...
                try:
                    ...
                    print("Error while sending hello to node_id:", node_index, e)
...
def sendShareCommits2Peers(M, nid):
    ...
    tobdx = {'my_id': nid, 'BroadcastCommit': str(share_commit_strings), 'epoch': 0}
...
def verify_received_shares(n, nid):
...
def node_thread(nid):
    ...
    share_send_thread = threading.Thread(target=sendShareCommits2Peers, args=(n, nid))
    ...
    share_verify_thread = threading.Thread(target=verify_received_shares, args=(n, nid))
    ...
    total_time = [total_process_time, total_clock_time]
