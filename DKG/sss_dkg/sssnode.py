...
nf.node_share_index = json.load(open("../../secretsharing/shamir/tmp/sss_node_share_index.txt"))
...
def node_thread(nid):
    ...
    timingfilename = "./tmp/sss_dkgtiming_n_"+str(nf.N_NODES)+".csv"
...
if __name__ == "__main__":
    ...
    nf.SECRET_SHARING = "SHAMIR"

    nf.N_NODES = args.nodes
    nf.MALICIOUS = args.malicious

    nf.M = genShamirDistMatrix(nf.N_NODES)
    nf.M = np.array(nf.M)
