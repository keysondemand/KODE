...
do
    ...
    then
        osascript -e 'tell app "Terminal" 
            do script "cd /Users/easwarvivek/Desktop/KODE/DKG/bbss_dkg/; python3 dprf_bbssnode.py -i '$j' -n '$NODES' -m 1"
        end tell'
    else
        osascript -e 'tell app "Terminal" 
            do script "cd /Users/easwarvivek/Desktop/KODE/DKG/bbss_dkg/; python3 dprf_bbssnode.py -i '$j' -n '$NODES' -m 0"
        end tell'
    fi 
done 
