...
do
    ...
    then
        osascript -e 'tell app "Terminal" 
            do script "cd /Users/easwarvivek/Desktop/KODE/DKG/sss_dkg/; python3 sssnode.py -i '$j' -n '$NODES' -m 1"
        end tell'
    else
        osascript -e 'tell app "Terminal" 
            do script "cd /Users/easwarvivek/Desktop/KODE/DKG/sss_dkg/; python3 sssnode.py -i '$j' -n '$NODES' -m 0"
        end tell'
    fi 
done 
